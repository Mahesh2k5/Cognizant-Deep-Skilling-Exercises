...
public class ProductSearch {
    ...
    public static void main(String[] args) {
        ...
        //Linear Search
        Product foundProductUsingLinear = linearSearch(products, searchId);
        if (foundProductUsingLinear != null) {
            System.out.println("Product found using Linear Search: " + foundProductUsingLinear);
        } else {
            System.out.println("Product not found using Linear Search.");
        }

        // With Binary Search
        Product foundProductUsingBinary = binarySearch(products, searchId);
        if (foundProductUsingBinary != null) {
            System.out.println("Product found using Binary Search: " + foundProductUsingBinary);
        } else {
